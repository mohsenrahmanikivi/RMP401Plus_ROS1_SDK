...
#include "segway_msgs/front_axle_angle_fb.h"
...
#include "segway_msgs/ros_set_chassis_buzzer_cmd.h"
...
#include "segway_msgs/ros_clear_chassis_error_code_cmd.h"
#include "segway_msgs/ros_enable_chassis_rotate_cmd.h"
#include "segway_msgs/ros_get_chassis_rotate_switch_cmd.h"
#include "segway_msgs/ros_get_chassis_SN_cmd.h"
#include "segway_msgs/ros_get_load_param_cmd.h"
#include "segway_msgs/ros_get_rotate_function_cfg_cmd.h"
#include "segway_msgs/ros_set_cfg_rotate_function_cmd.h"
#include "segway_msgs/ros_get_host_and_chassis_match_cmd.h"
#include "segway_msgs/ros_reset_host_power_cmd.h"
#include "segway_msgs/ros_start_chassis_left_rotate_cmd.h"
#include "segway_msgs/ros_start_chassis_right_rotate_cmd.h"
#include "segway_msgs/ros_stop_chassis_rotate_cmd.h"
...
namespace robot
{
    ...
    class Chassis
    {
        ...
        private:
            ...
            ros::Publisher front_axle_angle_fb_pub;
            ...
            segway_msgs::front_axle_angle_fb front_axle_angle_fb;
            ...
            bool ros_enable_chassis_rotate_cmd_callback(segway_msgs::ros_enable_chassis_rotate_cmd::Request &req, segway_msgs::ros_enable_chassis_rotate_cmd::Response &res);
            bool ros_get_chassis_rotate_switch_cmd_callback(segway_msgs::ros_get_chassis_rotate_switch_cmd::Request &req, segway_msgs::ros_get_chassis_rotate_switch_cmd::Response &res);
            bool ros_clear_chassis_error_code_cmd_callback(segway_msgs::ros_clear_chassis_error_code_cmd::Request &req, segway_msgs::ros_clear_chassis_error_code_cmd::Response &res);
            ...
            bool ros_get_chassis_SN_cmd_callback(segway_msgs::ros_get_chassis_SN_cmd::Request &req, segway_msgs::ros_get_chassis_SN_cmd::Response &res);
            ...
            bool ros_set_chassis_buzzer_cmd_callback(segway_msgs::ros_set_chassis_buzzer_cmd::Request &req, segway_msgs::ros_set_chassis_buzzer_cmd::Response &res);
            ...
            bool ros_reset_host_power_cmd_callback(segway_msgs::ros_reset_host_power_cmd::Request & req, segway_msgs::ros_reset_host_power_cmd::Response &res);
            bool ros_start_chassis_left_rotate_cmd_callback(segway_msgs::ros_start_chassis_left_rotate_cmd::Request & req, segway_msgs::ros_start_chassis_left_rotate_cmd::Response &res);
            bool ros_start_chassis_right_rotate_cmd_callback(segway_msgs::ros_start_chassis_right_rotate_cmd::Request & req, segway_msgs::ros_start_chassis_right_rotate_cmd::Response &res);
            bool ros_stop_chassis_rotate_cmd_callback(segway_msgs::ros_stop_chassis_rotate_cmd::Request & req, segway_msgs::ros_stop_chassis_rotate_cmd::Response &res);
            bool ros_get_rotate_function_cfg_cmd_callback(segway_msgs::ros_get_rotate_function_cfg_cmd::Request & req, segway_msgs::ros_get_rotate_function_cfg_cmd::Response &res);
            bool ros_set_cfg_rotate_function_cmd_callback(segway_msgs::ros_set_cfg_rotate_function_cmd::Request & req, segway_msgs::ros_set_cfg_rotate_function_cmd::Response &res);
            bool ros_get_host_and_chassis_match_cmd_callback(segway_msgs::ros_get_host_and_chassis_match_cmd::Request & req, segway_msgs::ros_get_host_and_chassis_match_cmd::Response &res);
            
            ros::ServiceServer ros_enable_chassis_rotate_cmd_srv_server;
            ros::ServiceServer ros_get_chassis_rotate_switch_cmd_srv_server;
            ros::ServiceServer ros_clear_chassis_error_code_cmd_srv_server;
            ros::ServiceServer ros_get_chassis_SN_cmd_srv_server;
            ...
            ros::ServiceServer ros_set_chassis_buzzer_cmd_srv_server;
            ...
            ros::ServiceServer ros_reset_host_power_cmd_srv_server;
            ros::ServiceServer ros_start_chassis_left_rotate_cmd_srv_server;
            ros::ServiceServer ros_start_chassis_right_rotate_cmd_srv_server;
            ros::ServiceServer ros_stop_chassis_rotate_cmd_srv_server;
            ros::ServiceServer ros_get_rotate_function_cfg_cmd_srv_server;
            ros::ServiceServer ros_set_cfg_rotate_function_cmd_srv_server;
            ros::ServiceServer ros_get_host_and_chassis_match_cmd_srv_server;
